...
int test_sort_function(std::vector<sort_data_t> &working_vector, const std::vector<sort_data_t> &source_vector,
                       const std::vector<sort_data_t> &sorted_vector, Callable fn, const char *name) {
...
int main() {
    ...
    for (auto &N : Ns) {
        ...
        res += test_sort_function(working_vector, source_vector, sorted_vector, sort_insertion, "sort_insertion");
        res += test_sort_function(working_vector, source_vector, sorted_vector, sort_selection, "sort_selection");
        res += test_sort_function(working_vector, source_vector, sorted_vector, sort_merge, "sort_merge");
        res += test_sort_function(working_vector, source_vector, sorted_vector, sort_heap, "sort_heap");
        res += test_sort_function(working_vector, source_vector, sorted_vector, sort_quick, "sort_quick");
    }
